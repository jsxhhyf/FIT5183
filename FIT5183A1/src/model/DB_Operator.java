...
public class DB_Operator {
	 ...
	 */
	public ArrayList<FlightEntity> queryFlightByDept(String deptString,
			String tableString) {
	...
	public ArrayList<FlightEntity> queryFlightByLocaAndDateAndTime(
			String deptString, String destString, String dateString,
			String timeString1, String timeString2, String tableString) {
	...
	public FlightEntity queryByFlightNoAndDateAndClass(String flightNoString,
		...
		resultSet = DBConnector.query(connection, QUERY_STRING + tableString
				+ " where FLNO = '" + flightNoString + "' and DPDT = '"
		...
		flightEntity = transformToFlightEntity(resultSet).get(0);
		try {
			connection.close();
		} catch (SQLException e) {
			// TODO Auto-generated catch block
